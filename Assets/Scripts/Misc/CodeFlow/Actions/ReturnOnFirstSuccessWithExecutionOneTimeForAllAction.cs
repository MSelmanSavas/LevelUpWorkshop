...
{
    [System.Serializable]
    public class ReturnOnFirstSuccessWithExecutionOneTimeForAllAction : CodeflowBaseAction
    {
        ...
        public override CodeflowState Execute()
        {
            ...
            {
                Logger.LogErrorWithTag(LogCategory.Codeflow, $"Error while trying to execute {nameof(ReturnOnFirstSuccessWithExecutionOneTimeForAllAction)}! Error : {e}");
